...
ActiveRecord::Schema.define(version: 2019_05_06_180144) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.datetime "dua_accepted_at"
    t.boolean "dua_agreed_to", default: false, null: false
    t.string "dua_legal_name"
    t.string "dua_remote_ip"
